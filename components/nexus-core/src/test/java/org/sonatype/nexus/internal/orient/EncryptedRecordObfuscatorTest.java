...
/**
 * Tests for {@link EncryptedRecordObfuscator}.
 */
public class EncryptedRecordObfuscatorTest
  extends TestSupport
{
  private EncryptedRecordObfuscator underTest;

  @Before
  public void setUp() throws Exception {
    this.underTest = new EncryptedRecordObfuscator(new CryptoHelperImpl(), "password", "salt", "0123456789ABCDEF");
  }
